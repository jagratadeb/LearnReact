...
function Card({username}) {
  ...
  <div class="flex-none w-48 mb-10 relative z-10 before:absolute before:top-1 before:left-1 before:w-full before:h-full before:bg-teal-400">
    <img src="https://images.pexels.com/photos/34341412/pexels-photo-34341412.jpeg" alt="" class="absolute z-10 inset-0 w-full h-full object-cover rounded-lg" loading="lazy" ></img>
  </div>
